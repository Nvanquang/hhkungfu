...
public enum ErrorConstants {
    ...
    VIDEO_MALFORMED("VIDEO_MALFORMED"),
    VIDEO_INVALID_FILENAME("VIDEO_INVALID_FILENAME"),
    VIDEO_BITRATE_TOO_HIGH("VIDEO_BITRATE_TOO_HIGH"),
    VIDEO_TOO_MANY_STREAMS("VIDEO_TOO_MANY_STREAMS"),
    VIDEO_INVALID_PATH("VIDEO_INVALID_PATH"),
